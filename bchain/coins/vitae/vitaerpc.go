...
// VitaeRPC is an interface to JSON-RPC bitcoind service.
type VitaeRPC struct {
	*btc.BitcoinRPC
    BitcoinGetChainInfo func() (*bchain.ChainInfo, error)
}

// NewVitaeRPC returns new VitaeRPC instance.
func NewVitaeRPC(config json.RawMessage, pushHandler func(bchain.NotificationType)) (bchain.BlockChain, error) {
...
// Initialize initializes VitaeRPC instance.
func (b *VitaeRPC) Initialize() error {
...
type ResGetInfo struct {
	...
	Result struct {
        ...
        ZerocoinSupply  bchain.ZCdenoms    `json:"zVITsupply"`
	} `json:"result"`
}
...
func (b *VitaeRPC) GetNextSuperBlock(nHeight int) int {
...
func (b *VitaeRPC) GetChainInfo() (*bchain.ChainInfo, error) {
...
func (b *VitaeRPC) Findzcserial(serialHex string) (string, error) {
